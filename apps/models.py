from django.db.models import Model, CharField, EmailField, ForeignKey, CASCADE, PositiveIntegerField, ImageField, TextField, ImageField, URLField,ForeignKey,DateTimeField
...
class Blog(Model):
    ...
    upload_at = CharField(max_length=111, null=True, blank=True)
